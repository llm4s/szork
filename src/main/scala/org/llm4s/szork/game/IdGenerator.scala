...
/** Utility for generating prefixed, truncated IDs for better readability and distinguishability.
  *
  * Format: {prefix}-{8-char-uuid} Examples:
  *   - game-a3b2c1d4
  *   - sess-f5e6d7c8
  *   - user-9a8b7c6d
  */
object IdGenerator {
  ...
  /** Generate a new ID with the specified prefix.
    *
    * @param prefix
    *   The prefix to use (e.g., "game", "sess", "user")
    * @return
    *   A formatted ID like "game-a3b2c1d4"
    */
  ...
  /** Validate that an ID has the expected format
    ...
    *   Optional expected prefix to check
    * @return
    *   true if valid
    */
