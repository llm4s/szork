...
/** Script to generate sample images for each art style to display on the style selection page Run with: sbt
  * "szork/runMain org.llm4s.szork.GenerateStyleSamples"
  */
