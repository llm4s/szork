...
/** Parses streaming response that has narration text followed by JSON. Format: Narration text here... <<<JSON>>>
...
class StreamingTextParser {
  ...
  /** Get the JSON portion of the response (after <<<JSON>>> marker). This method adds the narrationText field back into
    * the JSON.
    *
    * @return
    *   The JSON string with narrationText field added
    */
